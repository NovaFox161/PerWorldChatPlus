...
public class ChatFormat {
	...
	public static String determineMessageFormat(String originalFormat, String message, Player sender) {
		if (PerWorldChatPlusAPI.getApi().getConfig().get().getString("Format.Enabled").equalsIgnoreCase("True")) {
	...
	public static String getFormatTemplate(Player sender) {
		if (PerWorldChatPlusAPI.getApi().getConfig().get().getString("Format.PerWorld").equalsIgnoreCase("True")) {
			if (PerWorldChatPlusAPI.getApi().getConfig().get().contains("Format.Format." + sender.getWorld().getName())) {
				return PerWorldChatPlusAPI.getApi().getConfig().get().getString("Format.Format." + sender.getWorld().getName());
			}
		}
		return PerWorldChatPlusAPI.getApi().getConfig().get().getString("Format.Format.Default");
	}
	...
	public static String getGlobalTemplate() {
		return PerWorldChatPlusAPI.getApi().getConfig().get().getString("Format.Format.Global");
	}
	...
	public static String replacePrefixVariable(String format, Player sender) {
		if (format.contains("%prefix%") && PerWorldChatPlusAPI.getApi().getChat() != null) {
	...
	public static String replaceSuffixVariable(String format, Player sender) {
		if (format.contains("%suffix%") && PerWorldChatPlusAPI.getApi().getChat() != null) {
	...
	public static String replaceFactionNameVariable(String format, Player sender) {
		if (format.contains("%factionName%") && PerWorldChatPlusAPI.getApi().hasFactions()) {
	...
	public static String replaceFactionTagVariable(String format, Player sender) {
		if (format.contains("%factionTitle%") && PerWorldChatPlusAPI.getApi().hasFactions()) {
			MPlayer mSender = MPlayer.get(sender.getUniqueId());
