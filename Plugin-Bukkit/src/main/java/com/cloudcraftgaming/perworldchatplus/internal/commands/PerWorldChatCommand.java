...
import com.cloudcraftgaming.perworldchatplus.api.chat.TimedGlobalChatManager;
		...
		if (command.getName().equalsIgnoreCase("pwc") || command.getName().equalsIgnoreCase("pwcp")
			...
			if (sender instanceof Player) {
					...
					if (type.equalsIgnoreCase("spy")) {
						if (!(player.hasPermission("pwcp.spy"))) {
							...
							if (PlayerDataManager.hasGlobalChatSpyEnabled(player)) {
                                ...
                                String msg = MessageManager.getMessages().get().getString("Command.Spy.Disabled");
								player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
							} else {
								PlayerDataManager.setChatSpy(player, true);
                                String msg = MessageManager.getMessages().get().getString("Command.Spy.Enabled");
								player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
							}
						}
						...
						if (!(player.hasPermission("pwcp.bypass"))) {
							...
							if (PlayerDataManager.hasGlobalBypassEnabled(player)) {
                                ...
                                String msg = MessageManager.getMessages().get().getString("Command.Bypass.Disabled");
								player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
							} else {
								PlayerDataManager.setGlobalBypass(player, true);
                                String msg = MessageManager.getMessages().get().getString("Command.Bypass.Enabled");
								player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
							}
						}
						...
						if (player.hasPermission("pwcp.mute")) {
							if (PlayerDataManager.hasChatMuted(player)) {
                                ...
                                String msg = MessageManager.getMessages().get().getString("Command.Mute.Disable");
								player.sendMessage(MessageManager.getPrefix() + ChatColor.translateAlternateColorCodes('&', msg));
							} else {
								PlayerDataManager.setChatMute(player, true);
                                String msg = MessageManager.getMessages().get().getString("Command.Mute.Enable");
								player.sendMessage(MessageManager.getPrefix() + ChatColor.translateAlternateColorCodes('&', msg));
							}
						} else {
                        ...
                        String msg = MessageManager.getMessages().get().getString("Notification.Args.Invalid");
						player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
					}
					...
					if (type.equalsIgnoreCase("alert")) {
						if (!(player.hasPermission("pwcp.alert"))) {
							...
							if (PlayerDataManager.hasAlertWord(player, word)) {
                                ...
                                String msgOr = MessageManager.getMessages().get().getString("Command.Alert.Removed");
								String msg = msgOr.replaceAll("%word%", word);
								player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
							} else {
								PlayerDataManager.addAlertWord(player, word);
                                String msgOr = MessageManager.getMessages().get().getString("Command.Alert.Added");
								String msg = msgOr.replaceAll("%word%", word);
								player.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
							}
						}
				...
				if (args.length < 1) {
                    ...
                    String msg = MessageManager.getMessages().get().getString("Notification.Args.TooMany");
					sender.sendMessage(pr + ChatColor.translateAlternateColorCodes('&', msg));
				}
			}
		}
