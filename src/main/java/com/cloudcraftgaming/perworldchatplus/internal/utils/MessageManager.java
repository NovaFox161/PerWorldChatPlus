...
public class MessageManager {
	...
	public static void createEnglishMessagesFile() {
		...
		if (!(enFile.exists())) {
			...
			en.addDefault("Chat.Spam.Kick.Player", "&4Kicked automatically for spamming!");
			en.addDefault("Chat.Spam.Kick.Announcement", "&6%player% &6was automatically kicked for spamming!");
